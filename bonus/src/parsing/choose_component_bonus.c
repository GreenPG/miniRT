...
/*   Updated: 2023/06/30 11:33:14 by gpasquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <minirt_bonus.h>

static void	choose_component_part5(t_scene **scene, char *line)
{
	if (ft_strncmp(line, "tr", 2) == 0 && (!line[2]
			|| ft_isspace(line[2]) == 1))
	{
...
{
	if (ft_strncmp(line, "el", 2) == 0 && (!line[2]
			|| ft_isspace(line[2]) == 1))
	{	
	...
	{	
		...
		choose_component_part5(scene, line);
	return ;
}
