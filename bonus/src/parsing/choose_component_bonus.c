...
{
	if (ft_strncmp(line, "el", 2) == 0 && ft_isspace(line[2]) == 1)
	{	
	...
	else if (ft_strncmp(line, "cy", 2) == 0 && ft_isspace(line[2]) == 1)
	{	
	...
	else if (ft_strncmp(line, "tr", 2) == 0 && ft_isspace(line[2]) == 1)
	{
...
{
	if (ft_strncmp(line, "sp", 2) == 0 && ft_isspace(line[2]) == 1)
	{	
	...
	else if (ft_strncmp(line, "pl", 2) == 0 && ft_isspace(line[2]) == 1)
	{
...
{
	if (ft_strncmp(line, "C", 1) == 0 && ft_isspace(line[1]) == 1)
	{	
		if ((*scene)->camera)
		{
	...
	else if (ft_strncmp(line, "L", 1) == 0 && ft_isspace(line[1]) == 1)
	{
		if (!(*scene)->light_list)
...
void	choose_component(char *line, t_scene **scene)
{
	...
	while (line[i] && ft_isspace(line[i]) == 1)
		i++;
	if (ft_strncmp(line + i, "A", 1) == 0 && ft_isspace(line[1]) == 1)
	{
		if ((*scene)->ambiant_l)
		{
