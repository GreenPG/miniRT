...
/*   Updated: 2023/06/11 12:47:44 by gtouzali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	texture_plane(t_vector vec, t_obj_list *nearest, t_camera *camera)
{
	t_plane *plane;
...
int	get_texture(t_obj_list *nearest, t_vector ray, t_normal normal, t_camera *camera)
{
	...
	if (nearest->type == plane)
		color = texture_plane(normal.origin, nearest, camera);
