...
/*   Updated: 2023/05/22 13:57:44 by gpasquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <minirt.h>

static double	sphere_shadow(t_sphere *sphere, t_normal normal, t_vector light_dir)
{
	t_vector	oc;
	double		a;
	double		b;
...
int	get_diffuse_ratio(t_scene *scene, t_normal normal)
{
	...
	if (light_intersect(scene, light_dir, normal) == 1)
		return (0);
